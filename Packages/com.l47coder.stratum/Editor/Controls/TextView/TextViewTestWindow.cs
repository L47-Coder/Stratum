...
{
    public sealed class TextViewTestWindow : EditorWindow
    {
        ...
        [MenuItem("Tools/Dev Workbench/TextView Test")]
        private static void Open()
        {
            var w = GetWindow<TextViewTestWindow>("TextView Test");
        ...
        private void DrawOptions()
        {
            using (new EditorGUILayout.VerticalScope(EditorStyles.helpBox))
            {
                ...
                EditorGUILayout.HelpBox(
                    "TextView 为只读展示区；适合做日志、说明或生成结果预览。拖动窗口下缘可拉伸可视区域验证滚动条。",
                    MessageType.None);
            }
        }
        ...
        private static string BuildLongSample()
        {
            ...
            sb.AppendLine("Dev Workbench — TextView");
