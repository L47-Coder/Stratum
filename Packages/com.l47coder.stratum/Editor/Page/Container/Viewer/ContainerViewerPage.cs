...
namespace Stratum.Editor
{
    ...
    internal sealed class ContainerLeftPanel
    {
        ...
        {
            EnsureRootFolder();
            _treeView.Draw(rect, WorkbenchPaths.ContainerRoot);
        }
    ...
    internal sealed class ContainerCreatorPanel
    {
        ...
        private void DrawInputSection()
        {
            ...
            CreatorPageDraw.DrawHeader("New Container");
        ...
        private void DrawCreateButton()
        {
            ...
            {
                if (GUILayout.Button("Create Container", GUILayout.Height(CreatorPageDraw.CreateButtonHeight)))
                {
                    ContainerCreationService.CreateScript(_state);
                    _state.Reset();
