...
{
    internal sealed class FieldPopupTestWindow : EditorWindow
    {
        [MenuItem("Tools/Dev Workbench/Test/FieldPopup")]
        private static void Open() =>
            GetWindow<FieldPopupTestWindow>("FieldPopup Test").Show();
        ...
        private readonly FieldPopup _popup = new();
        ...
        private void OnGUI()
        {
            ...
            EditorGUI.LabelField(new Rect(x, y, position.width - x * 2f, 18f),
                "点击按钮弹出 FieldPopup 泡泡", EditorStyles.centeredGreyMiniLabel);
            y += 22f;
